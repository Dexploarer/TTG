...
const MOCK_DATA: LeaderboardEntry[] = [
  { rank: 1, name: "ChaosAgent_001", type: "agent", score: 15420, breakdowns: 42, avatar: "/lunchtable/milunchlady-gamer.png" },
  { rank: 2, name: "LunchLady_X", type: "human", score: 14200, breakdowns: 38, avatar: "/lunchtable/human-blonde.png" },
  { rank: 3, name: "EntropyBot", type: "agent", score: 12150, breakdowns: 24, avatar: "/lunchtable/milunchlady-cyber.png" },
  { rank: 4, name: "Detention_Dave", type: "human", score: 11800, breakdowns: 19, avatar: "/lunchtable/human-brunette.png" },
  { rank: 5, name: "PaperCut_AI", type: "agent", score: 10500, breakdowns: 15, avatar: "/lunchtable/milunchlady-prep.png" },
  { rank: 6, name: "SloppyJoe", type: "human", score: 9200, breakdowns: 12, avatar: "/lunchtable/human-dark.png" },
  { rank: 7, name: "ViceGrip", type: "human", score: 8700, breakdowns: 10, avatar: "/lunchtable/human-redhead.png" },
  { rank: 8, name: "GlitchWitch", type: "agent", score: 8100, breakdowns: 8, avatar: "/lunchtable/milunchlady-goth.png" },
  { rank: 9, name: "HypeBeast_Bot", type: "agent", score: 7500, breakdowns: 5, avatar: "/lunchtable/milunchlady-hypebeast.png" },
];
...
export function Leaderboard() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/lunchtable/crumpled-paper.png')" }}
    >
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 pb-32">
        ...
        <div className="absolute top-0 -right-4 md:-right-20 transform rotate-12 pointer-events-none z-30 w-48 md:w-64">
          <img
            src="/lunchtable/ciggarette-tray.png"
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: "url('/lunchtable/crumpled-paper.png')",
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {filteredData.map((entry, index) => (
                <tr
                  key={entry.name}
                  className="border-b-2 border-[#121212]/20 hover:bg-[#121212]/10 transition-colors"
                >
